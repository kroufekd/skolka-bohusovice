    ...
    <div class="container-fluid" style="padding: 0px;">
        <div class="container-fluid bounce animated"
            ...
            <h1 class="text-center" style="/*padding-left: 60px;*/padding-top: 50px;"><span class="text-center"
                    style="/*border-bottom: 2px solid black;*/">Zápis 2022/2023</span></h1>
                ...
                <div style="margin-top:6vh">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>Informace</h2>
                            <iframe
                                src="assets/dokumenty/zápis/Informace k přijímání dětí 2022.pdf"
                                frameborder="1" width="100%" height="800px" style="zoom: 0.5"></iframe>
                                <p></p>
                        </div>
                        <div class="col-lg-6">
                            <h2 class="headbar-sm">Potřebná dokumentace</h2>
                            <ul>
                                <li><a href="assets/dokumenty/zápis/Evidencni-list-ms-.pdf" target="_blank">Evidenční
                                        list</a></li>
                                <li><a href="assets/dokumenty/zápis/KRITÉRIA_2022.pdf" target="_blank">Kritéria pro
                                        přijetí 2022</a>
                                </li>
                                <li><a href="assets/dokumenty/zápis/ŽÁDOST_o_přijetí_2022.pdf" target="_blank">Žádost o přijetí 2022</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="footer-clean" style="background-color: #ffd705;padding: 30px;padding-bottom: 0px;">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-sm-4 col-md-3 item">
                            <h3>Kde nás najdete?</h3><iframe allowfullscreen="" frameborder="0" width="100%"
                                height="200"
            ...
            <div class="text-center" style="width: 100%;height: 30px;"><span
                    style="font-weight: 100;color: grey;">Copyright
